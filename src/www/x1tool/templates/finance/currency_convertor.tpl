...
<div class="panel-body">
    ...
    <div align="center" class="list-group" style="display:none;" id="trend">
        <a class="list-group-item"><strong><span id="trend_title"></span></strong></a>
        <a class="list-group-item"><img src="" id="trend_img" style="max-width:100%"/></a>
    </div>
</div>
{% endblock %}
