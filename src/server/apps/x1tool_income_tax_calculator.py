...
class X1ToolTaxCalculator(X1Tool):
    ...
    DEFAULT_METADATA = {'name': "Tax Calculator", 'author': "Ken", 'comments': "Enjoy it.", 'template': 'finance/income_tax.tpl', 'category': X1Category.FINANCE}
    ...
    def run(self, args):
        ...
        if 'include_social_insurance' in args:
            ...
            if social_insurance_enable:
                if 'social_insurance_rate_table' in args:
                    insurance_rate_table = args['social_insurance_rate_table']
