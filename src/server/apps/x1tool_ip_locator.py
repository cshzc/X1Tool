...
class X1ToolIPLocator(X1Tool):
    ...
    DEFAULT_METADATA = {'name': "IP Locator", 'author': "Admin", 'comments': "Enjoy it.", 'template': "/programmer/ip_locator.tpl", 'route': '/programmer/ip_locator/', 'category': X1Category.PROGRAMMER}
